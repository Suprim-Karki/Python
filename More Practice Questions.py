...
def create_shopping_list():
    shopping_list = "your code here"  # empty shopping list to store items
    adding_items = "your code here"   # boolean variable to control the loop
    
    print("Shopping List Creator")
    print("Enter items for your shopping list. Type 'done' when finished.")
    
    while ("your code here"):  # condition to continue loop while still adding items
        item = "your code here"  # get user input for next item
        
        if ("your code here"):  # check if user is done adding items
            adding_items = "your code here"  # update control variable to exit loop
        else:
            "your code here"  # add item to shopping list
    
    return "your code here"  # return the complete shopping list

# Call function to get shopping list
my_shopping_list = "your code here"

# Display shopping list
print("\nYour Shopping List:")
if ("your code here"):  # check if shopping list is empty
    print("Your shopping list is empty!")
else:
    for "your code here" in "your code here":  # loop through items in shopping list
        print("your code here")  # display each item
